...
<fieldset>
    ...
    <p id="dnyamarketopinions_opinion_sent"><img class="dnyamarketopinions_flag" src="../img/admin/{if !$opinion}disabled{else}enabled{/if}.gif"> Просьба отправлена</p>
    ...
    <br>
    <p>
        {if !$opinion}<a id="submitAddOpinion" class="button" href="#"><img src="../img/admin/comment_edit.png">Попросить отзыв</a>{/if}
